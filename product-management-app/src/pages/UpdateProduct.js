    ...
    return (
        ...
        <div className="container d-flex justify-content-center my-5">
            <div className="card shadow-lg p-4 col-md-10 col-lg-8 bg-light">
                <h3 className="text-center text-primary mb-4">Product Update</h3>
                <form onSubmit={(e)=>onSubmit(e)}>
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            {/* Department */}
                            <div className="mb-3">
                                <label htmlFor="categody" className="form-label">Category</label>
                                <select className="form-select" id="categody"
                                name='category'
                                value={category}
                                onChange={(e)=>onInputChange(e)}>
                            ...
                            <div className="text-center">
                                <div className="d-flex justify-content-center">
                                    ...
                                    <Link  className="btn btn-outline-danger w-50 shadow-lg mx-1" to="/product-list">
                                        Cancel
                                    </Link>
                                </div>
                            </div>
